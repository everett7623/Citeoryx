...
class ContentItem {
	...
	public static function from_row( object $row ): self {
		...
		$item->health_score       = null !== $row->health_score ? (float) $row->health_score : null;
		$item->health_confidence  = $row->health_confidence;
		$item->ai_readiness_score = null !== $row->ai_readiness_score ? (float) $row->ai_readiness_score : null;
