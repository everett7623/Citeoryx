...
class Issue {
	...
	public static function from_row( object $row ): self {
		...
		$issue->impact_score    = $row->impact_score !== null ? (float) $row->impact_score : null;
		$issue->effort_score    = $row->effort_score !== null ? (float) $row->effort_score : null;
		$issue->priority_score  = $row->priority_score !== null ? (float) $row->priority_score : null;
